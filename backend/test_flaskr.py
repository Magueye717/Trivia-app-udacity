...
from setings import TEST_DB_NAME, DB_PORT, DB_URL, DB_USER
...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = DB_USER + "://{}/{}".format(
            DB_URL + DB_PORT, self.database_name)
...
def test_play_quiz_with_category_only(self):
...
def test_play_quiz_with_category_and_some_previous_questions(self):
...
def test_play_quiz_with_category_and_all_the_previous_questions(self):
